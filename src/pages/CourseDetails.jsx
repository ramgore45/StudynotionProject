...
import { CourseDetailssCard } from '../componenets/core/Course/CourseDetailssCard'
    ...
    const handleAddtoCart = () =>{
      console.log('Add To Cart start')
       if(user && user?.accountType === ACCOUNT_TYPE.INSTRUCTOR){
        toast.error("Your An Instructor ,you cant buy course")
       }
       if(token){
       ...
       setConfirmationModal({
        text1:"you are not logged in",
        text:"Please login To add to cartCourse",
        btn1Text:"Login",
        btn2Text:"Cacel",
        btn1Handler:()=>navigate("/login"),
        btn2Handler:()=>setConfirmationModal(null)
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden">
              ...
              <button className="bg-yellow-900" onClick={handleBuyCourse}>
                Buy Now
              </button>
